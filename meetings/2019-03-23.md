...
**10:40-11:00 关于增加`<video-image>`元素的提案 Proposal to add the `<video-image>` element**

演讲者：姚穗斌（腾讯） Vic Yao (Tencent)

**11:00-11:20 弹幕标准化计划与提案 Commentary subtitles standardization Plan and Proposal**

演讲者：徐嵩（咪咕） Song Xu (Migu)

**11:20-11:40 bilibili弹幕发展与实践 Development and practice of commentary subtitles in bilibili**

演讲者：谭兆歆（bilibili） Zhaoxin Tan (bilibili)

**11:40-12:10 讨论环节 Discussions**

**12:10-13:10 午饭 Lunch**

### 视频实践 Video in practice

**13:10-13:30 知乎Web播放器MSE实践 Media Source Extensions™ practice in Zhihu web player**

演讲者：王天笑（知乎） Tianxiao Wang (Zhihu)

**13:30-13:50 MPEG-DASH标准应用与实践 MPEG-DASH application and practice**

演讲者：丁建强（bilibili） Jianqiang Ding (bilibili)

**13:50-14:10 音视频服务系统建设实践 Building audio and video services in Xiaomi**

演讲者：吴子敬（小米） Zijing Wu (Xiaomi)

**14:10-14:30 西瓜播放器在视频容器解析方向的探索 Exploration of video container analysis in Xigua player**

演讲者：银国徽（字节跳动） Guohui Yin (Bytedance)

**14:30-15:10 讨论环节 Discussions**

**15:10-15:40 茶歇 Coffee Break**

### RTC实现 RTC deployment

**15:40-16:00 阿里巴巴的RTC实践之路 RTC practice in Alibaba**

演讲者：楼剑（阿里巴巴） Jian Lou (Alibaba)

**16:00-16:20 在基于WebRTC的实时流媒体系统中采用QUIC的实践 The Practice of Adapting QUIC in WebRTC-based Realtime Streaming System**
